 ...
 */
@Component
public class PolicySqlSource implements CommonDataSource, Wrapper {

	// JDBC 驱动名及数据库 URL
	private static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
	private static final String DB_URL = "jdbc:mysql://118.31.60.34:3306/dips_cloud_gov?useUnicode=true&useSSL=false&characterEncoding=UTF-8";
