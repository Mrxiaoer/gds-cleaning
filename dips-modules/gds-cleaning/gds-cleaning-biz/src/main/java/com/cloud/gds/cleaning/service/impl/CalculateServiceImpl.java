...
//				path + "/analysis_similarity/quickAnalyse.py", jsonFileUrl};
			arguments = new String[]{"/anaconda3/bin/python","/usr/local/data-cleaning/analysis_similarity/quickAnalyse.py", jsonFileUrl};
...
//				path + "/analysis_similarity/deepAnalyse.py", jsonFileUrl};
			arguments = new String[]{"/anaconda3/bin/python","/usr/local/data-cleaning/analysis_similarity/deepAnalyse.py", jsonFileUrl};
		}
		try {
			//调用python的相似度计算程序
...
//			path + "/analysis_similarity/centroidAnalyse.py", jsonStr};
		String[] arguments = new String[]{"/anaconda3/bin/python","/usr/local/data-cleaning/analysis_similarity/centroidAnalyse.py", jsonStr};
		try {
			//调用python标准分析程序
			Process process = Runtime.getRuntime().exec(arguments);
			//将得到的数据进行io处理
