...
public class OtherTest {
	...
	public void hanlp() {
		String document =
			"<font>所属主题：法制</font><font>发文日期：2015-02-02</font><font>公开责任部门：省政府法制办公室</font></p>"
				+ "<font>所属主题：法制</font><font>发文日期：2016-02-02</font><font>公开责任部门：省政府法制办公室</font></p>"
				+ "<font>所属主题：法制</font><font>发文日期：2017-02-02</font><font>公开责任部门：省政府法制办公室</font></p>";
		//定义HTML标签的正则表达式，去除标签，只提取文字内容
		// String htmlRegex="<[^>]+>";
		String pattern2 = ".*(发文日期|生成日期)[\\s\\S][\\s]*?(\\d+[-|年]\\d+[-|月]\\d+[日]?)";
		...
		if (m2.find()) {
			try {
				Date date = sdfF1
					.parse(StrUtil.trim(m2.group(2)+" 00:00:11"));
