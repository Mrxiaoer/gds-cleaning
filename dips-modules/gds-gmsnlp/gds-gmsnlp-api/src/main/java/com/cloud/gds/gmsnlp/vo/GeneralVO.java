package com.cloud.gds.gmsnlp.vo;
...
public class GeneralVO implements Serializable {
	 ...
	 * 发文单位（关联机构）
	 */
	private List<CommonVO> dispatchList = new ArrayList<>();
	/**
	 * 联合发文单位（关联机构）
	 */
	private List<CommonVO> unionList = new ArrayList<>();
	/**
...
//	private Date writeTime;
	 ...
	 * 政策依据（关联政策）
	 */
	private List<CommonVO> policyList = new ArrayList<>();
	/**
	 * 适用区域（关联地域）
	 */
	private List<CommonVO> regionList = new ArrayList<>();
	/**
	 ...
	 * 标签
	 */
	private List<CommonVO> tagList = new ArrayList<>();
	/**
	 * 附件（附件地址）
	 */
	 ...
	 * 地域编码
	 */
	private List<String> regionArr = new ArrayList<>();
	/**
	 * 审核状态
	 */
